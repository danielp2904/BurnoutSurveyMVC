...
namespace BurnoutSurveyMVC.Data
{
    public static class SeedData
    {
        public static void Initialize(PesquisaContext db)
        {
            ...
            string expEx = "1. Exaustão emocional: avalia desgaste e esgotamento no trabalho";
            ...
            string expDe = "2. Despersonalização: atitudes de cinismo/indiferença em relação ao trabalho";
            ...
            string expRp = "3. Realização pessoal (invertida no cálculo): percepção de competência e crescimento";
